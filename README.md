...
```
(terminal)$ git clone https://github.com/yussasif/printf.git
(terminal)$ cd printf
```
Sample main program inside _printf.c:
```
int main(void)
{
...
====================================
(terminal)$ gcc -Wall -Werror -Wextra -pedantic -Wno-format *.c -o _printf
(terminal)$ ./_printf
Hello W0rld
(terminal)$
```
...
---
### Authors
Owoade Yusuf https://www.github.com/yussasif
Oyebamiji Sodiq https://www.github.com/oyebamijisodiq
